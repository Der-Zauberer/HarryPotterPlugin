        ...
        setSpellCastAction(event -> {
            ...
            spellProjectile.setHitEntityAction(entity -> {
                if (entity instanceof LivingEntity) {
                    ...
                    if (!damageEvent.isCancelled() && damageEvent.getEntity() instanceof LivingEntity)
                        ((LivingEntity) damageEvent.getEntity()).damage(damageEvent.getDamage(), damageEvent.getDamager());
                }
            });
